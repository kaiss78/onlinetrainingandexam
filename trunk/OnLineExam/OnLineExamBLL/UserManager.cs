...
namespace OnLineExamBLL
{
    ...
    {
        public static IList<Scores> selectAllScore(string PaperID)
        {
            UserService UserService = new UserService();
            IList<Scores> list = UserService.SelectAll(PaperID);

            return list;
        }

        public static IList<Scores> selectAlls()
        {
            UserService UserService = new UserService();
            IList<Scores> list = UserService.SelectAll();
