                        ...
                        <table cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc" style="border-collapse: collapse"
                            ...
                            <tr>
                                <td style="text-align: right; width: 100%;" colspan="2">
                                    <div class="title" align="left">
                                        <h4>
                                            练习：<asp:Label ID="lblMessage2" runat="server" ForeColor="red"></asp:Label></h4>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: right; width: 100%; height: 25px;" colspan="2">
                                    <div class="title" align="left">
                                        <h4>
                                            练习记录：<asp:Label ID="lblScore2" runat="server" Text="" Width="126px"></asp:Label>
                                        </h4>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <div align="left">
                                        <asp:GridView ID="GridView4" runat="server" AllowPaging="True" OnRowDataBound="GridView1_RowDataBound"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="练习">
                                                    <ItemTemplate>
