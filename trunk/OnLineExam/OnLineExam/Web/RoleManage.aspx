                    ...
                    <td valign="top" align="left" width="960px">
                        ...
                        <asp:GridView ID="GV" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="部门信息管理">
                                    <ItemTemplate>
                        ...
                        <br />
                        <p align="center">
                            <asp:ImageButton ID="ImageButtonGiant" runat="server" ImageUrl="~\Images\BtnGiant.gif"
                                OnClick="ImageButtonGiant_Click"></asp:ImageButton></p>
                    </td>
                </tr>
            </table>
        </ContentTemplate>
