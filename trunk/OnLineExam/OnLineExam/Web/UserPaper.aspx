                ...
                <table style="border-collapse: collapse" bordercolor="#cccccc" cellspacing="0" cellpadding="0"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                &nbsp;<div align="left">
                                    &nbsp;&nbsp;<asp:Label ID="filScore" runat="server" Text="0" Font-Bold="true"></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
    ...
    <table cellspacing="0" style="font-size: 12px; font-family: Tahoma; border-collapse: collapse;"
        ...
        <tr>
            <td>
                <br />
                <center>
                    <asp:Button ID="Button1" runat="server" Text="问答题计分" OnClick="Button1_Click" CausesValidation="true" />
                </center>
            </td>
        </tr>
    </table>
